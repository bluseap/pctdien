var addeditthoiviecController = function () {
    ...
    function registerEvents() {
        ...
        $("#ddl-show-pageHoSoQDTV").on('change', function () {
            tedu.configs.pageSize = $(this).val();
            tedu.configs.pageIndex = 1;
            LoadTableHoSo(true);
        });

        $('body').on('click', '.btn-editHoSoQDTV', function (e) {
            e.preventDefault();
    ...
    function LoadTableHoSo(isPageChanged) {
        var template = $('#table-HoSoQDTV').html();
        var render = "";
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#lblHoSoQDTVTotalRecords').text(response.Result.RowCount);

                if (render !== '') {
                    $('#tblContentHoSoQDTV').html(render);
                }
    ...
    function wrapPagingHoSo(recordCount, callBack, changePageSize) {
        ...
        if ($('#paginationULHoSoQDTV a').length === 0 || changePageSize === true) {
            $('#paginationULHoSoQDTV').empty();
            $('#paginationULHoSoQDTV').removeData("twbs-pagination");
            $('#paginationULHoSoQDTV').unbind("page");
        }
        //Bind Pagination Event
        $('#paginationULHoSoQDTV').twbsPagination({
