var giaydnController = function () {
    ...
    function registerEvents() {
        ...
        $("#btn-create").on('click', function (e) {
            ...
            $('#hidGiayDeNghiDMCungCapNuocCodeXuLy').val(guid);
        ...
        $('body').on('click', '.btn-addeditGiayDeNghiCungCapNuoc', function (e) {
            e.preventDefault();
            ...
            addeditgdn.editGiayDeNghiNuoc(giaydenghiid);
            $('#modal-add-edit-GiayDeNghi').modal('show');
        });
    ...
    function loadData() {
        ...
        var dieukienExcel = [{ value: "DDNUOCNGAYNHAN", Name: "DS Di dời Nước theo ngày tiếp nhận" },
