var chuyenkiemtraController = function () {
    ...
    function registerEvents() {
        ...
        $("#ddlKiemTraDMCungCapDichVu").on('change', function () {
            var giaydenghidmcungcapdienId = $("#ddlKiemTraDMCungCapDichVu").val();
    ...
    function loadChuyenKiemTraData(giaydenghiid) {
        return $.ajax({
            ...
            url: '/admin/giaydndien/GDNDMDienByGDNId',
            dataType: 'json',
    ...
    function saveKiemTraChuyenXuLy() {
        ...
        var giaydennghidmcungcapdienid = $('#hidGiayDeNghiDMCungCapDienId').val();
        ...
        $.ajax({
            type: "POST",
            url: "/Admin/giaydndien/ChuyenXuLy",
            data: {
                giaydenghiId: giaydenghiid,
                giaydenghidmcungcapdienId: giaydennghidmcungcapdienid,
            ...
            success: function (response) {
                if (response.Result === false) {
                    ...
                    addeditddn.loadTableGiayDeNghiDien(true);
