...
{
    public class ThayHopDongPoService : IThayHopDongPoService
    {
        private readonly IConfiguration _configuration;

        public ThayHopDongPoService(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<ThayHopDongPoViewModel> Get_ThayHopDongPo_ByIdMakvPo(string thayhopdongpoidmakv)
        {
            using (var sqlConnection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
            {
                ...
                dynamicParameters.Add("@ThayHopDongPoIdMakv", thayhopdongpoidmakv);

                try
                {
                    var query = await sqlConnection.QueryAsync<ThayHopDongPoViewModel>(
                        "Get_ThayHopDongPo_ByIdMakvPo", dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public async Task<PagedResult<ThayHopDongPoViewModel>> Get_ThayHopDongPo_AllPaging(string khuvuc, string keyword,
            int page, int pageSize)
        {
            using (var sqlConnection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
            {
                ...
                try
                {
                    var result = await sqlConnection.QueryAsync<ThayHopDongPoViewModel>("Get_ThayHopDongPo_AllPaging", dynamicParameters, null, null,
                        System.Data.CommandType.StoredProcedure);

                    int totalRow = dynamicParameters.Get<int>("@totalRow");

                    var pagedResult = new PagedResult<ThayHopDongPoViewModel>()
                    {
        ...
        public async Task<PagedResult<ThayHopDongPoViewModel>> Get_ThayHopDongPo_ByLoaiHopDongPaging(string khuvuc, string loaihopdong,
            string keyword, int page, int pageSize)
        {
            using (var sqlConnection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
            {
                ...
                try
                {
                    var result = await sqlConnection.QueryAsync<ThayHopDongPoViewModel>("Get_ThayHopDongPo_ByLoaiHopDongPaging", dynamicParameters, null, null,
                        System.Data.CommandType.StoredProcedure);
        ...
        public async Task<PagedResult<ThayHopDongPoViewModel>> Get_ThayHopDongPo_ByDsHopDongTheoPaging(string khuvuc, string dshopdongtheo,
            string keyword, int page, int pageSize)
        {
            using (var sqlConnection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
            {
                ...
                try
                {
                    var result = await sqlConnection.QueryAsync<ThayHopDongPoViewModel>("Get_ThayHopDongPo_ByDsHopDongTheoPaging", dynamicParameters, null, null,
                        System.Data.CommandType.StoredProcedure);
        ...
        public async Task<bool> Create_ThayHopDongPo(ThayHopDongPoViewModel thayhopdong, DateTime createDate, string createBy)
        {
            using (var sqlConnection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
            {
                await sqlConnection.OpenAsync();
                ...
                dynamicParameters.Add("@MaKhachHangPo", thayhopdong.MaKhachHangPo);
                ...
                try
                {
                    await sqlConnection.QueryAsync<ThayHopDongPoViewModel>(
                        "Create_ThayHopDongPo", dynamicParameters, commandType: CommandType.StoredProcedure);
                    return true;
                }
                catch (Exception ex)
                {
        ...
        public async Task<bool> Update_ThayHopDongPo(ThayHopDongPoViewModel thayhopdong, DateTime updateDate, string updateBy)
        {
            using (var sqlConnection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
            {
                await sqlConnection.OpenAsync();
                ...
                dynamicParameters.Add("@ThayHopDongPoIdMaKvPo", thayhopdong.ThayHopDongPoIdMaKvPo);
                ...
                {
                    await sqlConnection.QueryAsync<ThayHopDongPoViewModel>(
                        "Update_ThayHopDongPo", dynamicParameters, commandType: CommandType.StoredProcedure);
                    return true;
                }
                catch (Exception ex)
                {
