        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.Results.length === 0) {
                    ...
                    powa.notify('Đăng ký ldddắp mới.', 'success');
                    ...
                    $('#hidTTCacDichVuNuocId').val(response.RowCount);

                    loadDataDichVuNuocId();
                }
            },
            //cache: false,
            error: function (err) {
...
function loadDataDichVuNuocId() {
    var dichvunuocid = $('#hidTTCacDichVuNuocId').val();

    $.ajax({
        type: 'GET',
        url: '/DichVuNuoc/GetId',
        data: {
