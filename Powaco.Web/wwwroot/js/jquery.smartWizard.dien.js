...
function isFormMainValidateHinhMucDich() {
    if ($('#frmDangKyDienHinhMucDich').valid()) {
        return true;
    }
    else {
        return false;
...
function formMainValidateHinhMucDich() {
    ...
    //Init validation
    $('#frmDangKyDienHinhMucDich').validate({
        errorClass: 'red',
        ignore: [],
        language: 'vi',
        rules: {            
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.Results.length === 0) {
                    ...
                    $('#hidTTDangKyDienId').val(response.RowCount);

                    loadDataDangKyDienId();
                }
            },
            //cache: false,
            error: function (err) {
...
function loadDataDangKyDienId() {
    var dangkuydienid = $('#hidTTDangKyDienId').val();

    $.ajax({
        type: 'GET',
        url: '/dangkydien/GetId',
        data: {
            dangkydienId: dangkuydienid
        },
        dataType: "json",
        success: function (response) {
