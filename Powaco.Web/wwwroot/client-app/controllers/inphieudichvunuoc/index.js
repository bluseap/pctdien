(function () {
    ...
    function loadPhieuTiepNhanDien() {
        var cachdichvunuocid = $('#hidTTCacDichVuNuocId').val();

        $.ajax({
            type: 'GET',
            url: '/RpInPhieuDichVuNuoc/GetById',
            data: {
                dichvunuocId: cachdichvunuocid
            },
            dataType: 'json',
