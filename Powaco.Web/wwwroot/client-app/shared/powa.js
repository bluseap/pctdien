var powa = {
    ...
    getFormattedDateTimeHourTTDangKy: function (datetime) {
        if (datetime === null || datetime === '')
            return '';
        ...
        return hh + ' giờ ' + mm + ' phút, ngày ' + day + ' tháng ' + month + ' năm ' + year;
    },
    getFormattedDateNgayThangNamTTDangKy: function (datetime) {
        if (datetime === null || datetime === '')
            return '';
