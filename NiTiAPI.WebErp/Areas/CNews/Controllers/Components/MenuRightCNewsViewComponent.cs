...
{
    public class MenuRightCNewsViewComponent : ViewComponent
    {
        private readonly IStringLocalizer<HomeController> _localizer;
        private ICategoryNewsRepository _categoryNewsRepository;

        public MenuRightCNewsViewComponent(IStringLocalizer<HomeController> localizer, ICategoryNewsRepository categoryNewsRepository)
        {
