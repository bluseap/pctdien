var niti = {
    ...
    getOrderDetails: function (trangthai) {
        if (trangthai === 3)
            return '<span class="badge bg-green">Đơn mới</span>';
        else if (trangthai === 6)
            return '<span class="badge bg-orange">Đang đi</span>';
        else if (trangthai === 9)
            return '<span class="badge bg-blue">Đã đến</span>';
        else if (trangthai === 99)
            return '<span class="badge bg-red">Hủy đơn</span>';
        //else if (trangthai === 4)
        //    return '<span class="badge bg-purple">Phát hành</span>';
        //else if (trangthai === "5")
        //    return '<span class="badge bg-red">Xử lý lại</span>';        
