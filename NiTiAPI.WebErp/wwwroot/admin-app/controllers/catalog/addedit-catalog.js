...
var addeditcatalogController = function () {
    ...
    function loadCatalogParent(corporationid) {
        return $.ajax({
            type: 'GET',
            url: '/admin/catalog/GetCoporationId',
                ...
                $('#treeCatalog').tree({
                    ...
                    onDrop: function (target, source, point) {
                        ...
                        if (point === 'append') {
                            ...
                            //niti.notify(source.id, "success");
                            //niti.notify(targetNode.id, "success");
    ...
    function saveCatalog(e) {
        ...
        if ($('#frmMaintainance').valid()) {
            ...
            $.ajax({
                ...
                success: function () {
                    niti.appUserLoginLogger(userName, "Save Catalog.");
